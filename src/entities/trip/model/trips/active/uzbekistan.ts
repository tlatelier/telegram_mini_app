...
const activeTripDataUzbekistan: TripDataType = {
    ...
    date: '1–5 апреля',
    background: '/images/trips/active/uzbekistan/promo/uzbekistan-promo-1.webp',
    destination: 'Узбекистан',
    title: 'Узбекистан: Цветение жизни',
    dateStart: '1 апреля',
    dateEnd: '5 апреля',
    gallery: [
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-1.webp',
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-2.webp',
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-3.webp',
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-4.webp',
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-5.webp',
        '/images/trips/active/uzbekistan/promo/uzbekistan-promo-6.webp',
    ],
    priceFrom: 1050,
    currency: 'USD',
    duration: '5',
    ...
    days: [
        {
            ...
            photo: '/images/trips/active/uzbekistan/programm/uzbekistan-programm-1.webp',
        },
        {
            title: 'Самарканд',
            activities: [
            ...
            photo: '/images/trips/active/uzbekistan/programm/uzbekistan-programm-2.webp',
        },
        {
            ...
            photo: '/images/trips/active/uzbekistan/programm/uzbekistan-programm-3.webp',
        },
        {
            title: 'Бухара',
            activities: [
            ...
            photo: '/images/trips/active/uzbekistan/programm/uzbekistan-programm-4.webp',
        },
        {
            title: 'Вылет домой',
            activities: [
            ...
            photo: '/images/trips/active/uzbekistan/programm/uzbekistan-programm-5.webp',
        },
    ],
    faq: [
        {
