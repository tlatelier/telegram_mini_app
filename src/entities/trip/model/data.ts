...
const tripData: TripDataType[] = [
  {
    ...
    date: "1 января",
    background:
      "url(https://cdn.tripster.ru/photos/6b006c48-d11e-4e66-9d8e-c884f382113e.jpg)",
    destination: "Милан",
    ...
    days: [
      {
        ...
        description:
          "Дуомо, Галерея Виктора Эммануила II, аперитив на площади.",
        photo:
          "https://cdn.tripster.ru/photos/6b006c48-d11e-4e66-9d8e-c884f382113e.jpg",
      },
      {
        title: "Озеро Комо",
    ...
    days: [
      {
        ...
        description: "Вертолетная экскурсия и купание в термальных источниках.",
      },
      {
        title: "Вулканы и Тихий океан",
        description: "Трекинг по лавовым полям, пикник у океана.",
      },
    ],
  },
];

export { tripData, tripDetails };
